...
The experiment-design pass is complete and frozen as version `phase0-0.1.0`.
...
- The canonical model and four JSON schemas have been created.
- A deterministic execution identity and hash contract has been fixed.
- A transparent lexicographic objective policy has been fixed as a benchmark policy only.
...
- The bundle has been structurally validated and hashed.
...
- No remote GitHub repository has been created.

## Entry condition for Phase 1

Phase 1 begins only after the frozen protocol is reviewed. Amendments must be recorded under `docs/10-change-control.md` before results are generated.
